		...
		<div class="container">
			<div class="row">
				...
				<video width="320" height="240" controls>
					<source src="video/${newsone.newsVideoName}" type="video/mp4">
				</video>
				<h3>${newsone.newsTitle}</h3>
				<p>內文: ${newsone.newsContent}</p>
				<p>作者: ${newsone.authorBean.name}</p>
...
<!-- 							<input type='submit' value='delete' name='deleteBtn'  > -->
						<a href="<spring:url value='/deleteNews/newsId'/>" class="btn btn-default">
							<span class="glyphicon-hand-left glyphicon"></span>刪除 </td>
<!-- 					</form:form> -->
				</p>
			</div>
