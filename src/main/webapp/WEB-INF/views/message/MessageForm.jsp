...
<body>
							...
							<fieldset class="fieldset-auto-width">
								...
								<table>
									...
									<tr class="test1">
										...
										<td><form:input style="background-color:white;width:500px"
												id="title1" class="tt1" path="title" onblur="doBlur()" placeholder="請輸入標題...." /><span 
											id="titlesp">  </span> 		
									<br>		
									<br>
									</td>
									...
									<tr>
										...
										<td><form:textarea class="cnt" path="content"
												id="editor" placeholder="請輸入內容..."  onblur="doBlur2()" /><br>&nbsp;<span
											id="contentsp"></span><br /></td>
									</tr>
									<tr>
										<td style="display: inline;">圖片:</td>
										<td><form:input style="background-color:white"
												id="productImage" path="productImage" type='file' /></td>
									</tr>
									<tr>
										<div id="smt">
											<td colspan='2' align='center' class="blog__item__text"><input
												style="background-color: white;" class="blog__btn"
												type='submit' value='發表'></td>
										</div>
									</tr>
	...
	<script>
							 ...
							 function doBlur(){
								...
								var spanId = document.getElementById("titlesp")
								if (theIdObjVal == "") {
									spanId.innerHTML = "   不可空白";
									spanId.style="color:red"
								} else if (LenId < 12) {
									spanId.innerHTML = "   內容最少12個字";
									spanId.style="color:red"
								} else {
									spanId.innerHTML = "  符合";
							 ...
							 function doBlur2(){
								 console.log("123")
									...
									var theIdObjVal = theIdObj.value;
									var LenId = theIdObjVal.length;
									var spanId = document.getElementById("contentsp")
									if (theIdObjVal == "") {
										spanId.innerHTML = " 不可空白";
										spanId.style="color:red"
									} else if (LenId < 10) {
										spanId.innerHTML = "內容最少10個字";
										spanId.style="color:red"
									} else {
										spanId.innerHTML = "符合";
										spanId.style="color:green"
